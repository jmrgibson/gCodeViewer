 ...
 * Time: 4:59 PM
 */
GCODE.renderer3d = function(bindToView) {

    /**
     * Holds the view that this renderer is bound to.
     * @type {GCODE.view}
     */
    var view = bindToView;
    ...
    var adjustSize = function() {
        WIDTH = parseInt(view.getRoot().find(".tab3d").css("width"));
        HEIGHT = parseInt(view.getRoot().find(".tab3d").css("height"));
        ASPECT = WIDTH / HEIGHT;
    ...
    var init = function () {
        ...
        if (renderOptions["rendererType"] == "webgl") {
            ...
            renderer = new THREE.CanvasRenderer({clearColor: 0xffffff, clearAlpha: 1});
        } else {
        ...
        var $container = view.getRoot().find('.3d_container');
